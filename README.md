...
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Quicksand&weight=600&size=22&pause=1000&color=2196F3&center=true&vCenter=true&width=600&lines=Software+Engineer;Web+%26+Mobile+Developer;Laravel+%26+Flutter+Enthusiast;UI%2FUX+Designer" alt="Typing SVG" />
  </a>
</div>
...
<table align="center" style="border-collapse: collapse; border: none; width: 100%;">
  <tr style="border: none;">
    <td width="60%" style="border: none; padding-right: 20px; vertical-align: top;">
      ...
      <p style="margin-bottom: 10px;">📫 <strong>Reach me out:</strong></p>
      <p>
    ...
    <td width="40%" align="center" style="border: none; vertical-align: top;">
      <a href="https://s.id/ahmadfauzi-portfolio-2026" target="_blank">
        <img src="portfolio.png" width="100%" style="border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.15);" alt="Portfolio Ahmad Fauzi"/>
      </a>
    </td>
  </tr>
</table>
    ...
    <td width="50%" valign="top" style="border: none; padding-right: 15px;">
      ...
      <ul style="padding-left: 20px;">
        <li style="margin-bottom: 15px;">
          <strong>Universitas Putera Batam</strong><br>
          B.S. in Information Systems (Candidate)<br>
          <span style="color: #666;"><i>GPA: 3.64/4.00 | Expected: 2027</i></span>
        </li>
        <li>
          <strong>SMKN 7 Batam</strong><br>
          Vocational Diploma in Software Engineering<br>
          <span style="color: #666;"><i>Jul 2020 - Apr 2023</i></span>
        </li>
      </ul>
    </td>
...
<p style="margin-bottom: 5px;"><strong>Yayasan Duta Inspirasi Indonesia</strong> <code>(Mar - Jun 2024)</code></p>
