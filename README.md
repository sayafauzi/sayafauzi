...
* [cite_start]Worked within a cross-functional team to translate complex requirements into functional code and elegant user interfaces[cite: 26].

### [cite_start]🎓 Education [cite: 27]
* **Universitas Putera Batam, Batam, Indonesia** - Bachelor of Science in Information Systems (Candidate)[cite: 28, 29]. Expected Graduation: 2027, GPA 3.64/4.00[cite: 30, 31].
* [cite_start]**State Vocational School 7 Batam (SMKN 7 Batam)** - Vocational Diploma in Software Engineering (Jul 2020 - Apr 2023)[cite: 32, 33].

### [cite_start]🏅 Certifications [cite: 38]
* CCNA: Switching, Routing, and Wireless Essentials (2026)[cite: 39].
* [cite_start]Python Programming Essentials (PPE) with Gen Al Tools - Casugol (2025)[cite: 40].
* [cite_start]SOLID Programming Principles - Dicoding Indonesia (2024)[cite: 41].
* Flutter Application Development - Dicoding Indonesia (2024)[cite: 42].
* [cite_start]React Development: Building High-Performance Uls - Dicoding (2024)[cite: 43].

### [cite_start]🤝 Volunteer & Leadership [cite: 34]
* [cite_start]**Yayasan Duta Inspirasi Indonesia** (Mar - Jun 2024) [cite: 35, 36][cite_start]: Had the opportunity to become a "Duta Inspirasi Indonesia batch 12" through national level selection to inspire and contribute to supporting Indonesia Emas 2045, and managed the development of social media content for the batch 12 inspiration ambassador[cite: 37].

### 📫 Connect with Me
* [cite_start]**Email:** ahmad.fauzi.aziz825@gmail.com 
* [cite_start]**LinkedIn:** [ahmad-fauzi-aziz](https://linkedin.com/in/ahmad-fauzi-aziz) 
* [cite_start]**GitHub:** [sayafauzi](https://github.com/sayafauzi)
